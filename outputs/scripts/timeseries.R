...
plot_gdp_to_file_v1 <- function(niter, firmiters, firmvector, cfirmiters, cfirmvector, gtype = "Nominal", beta = "0.25"){
	times <- (1:niter)
	fsums <- (1:niter)
	csums <- (1:niter)
	gdp <- (1:niter)
...
plot_gdp_to_file_v2 <- function(niter, firmiters, firmvector, cfirmiters, cfirmvector, Rfirmvector, Rcfirmvector, beta = "0.25"){
	times <- (1:niter)
	fsums <- (1:niter)
	csums <- (1:niter)
	gdp <- (1:niter)
...
plot_gdp_to_file_v1(nMonths, FirmMonthly$IT_NO,firmvector, CFirmMonthly$IT_NO, cfirmvector, gtype = "Nominal", beta = "0.20")
...
plot_gdp_to_file_v1(nMonths, FirmMonthly$IT_NO,firmvector_real, CFirmMonthly$IT_NO, cfirmvector_real, gtype = "Real", beta = "0.20")

plot_gdp_to_file_v2(nMonths, FirmMonthly$IT_NO,firmvector, CFirmMonthly$IT_NO, cfirmvector, firmvector_real, cfirmvector_real, beta = "0.20")
