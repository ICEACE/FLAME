...
plot_gdp_to_file_v1(nMonths, FirmMonthly$IT_NO,firmvector, CFirmMonthly$IT_NO, cfirmvector, EFirmMonthly$IT_NO, efirmvector, gtype = "Nominal", beta = betaval)
...
plot_gdp_to_file_v1(nMonths, FirmMonthly$IT_NO,firmvector_real, CFirmMonthly$IT_NO, cfirmvector_real, EFirmMonthly$IT_NO, efirmvector_real, gtype = "Real", beta = betaval)
