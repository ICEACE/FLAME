...
/** \def START_FIRM_FOREIGNSECTOR_AMOUNT_MESSAGE_LOOP
 * \brief Start of loop to process firm_foreignsector_amount messages. */
#define START_FIRM_FOREIGNSECTOR_AMOUNT_MESSAGE_LOOP  for(firm_foreignsector_amount_message = get_first_firm_foreignsector_amount_message(); firm_foreignsector_amount_message != NULL; firm_foreignsector_amount_message = get_next_firm_foreignsector_amount_message(firm_foreignsector_amount_message)) {
/** \def FINISH_FIRM_FOREIGNSECTOR_AMOUNT_MESSAGE_LOOP
 * \brief Finish of loop to process firm_foreignsector_amount messages. */
#define FINISH_FIRM_FOREIGNSECTOR_AMOUNT_MESSAGE_LOOP }
/** \def START_CENTRALBANK_FIRM_REVENUES_MESSAGE_LOOP
 * \brief Start of loop to process centralbank_firm_revenues messages. */
#define START_CENTRALBANK_FIRM_REVENUES_MESSAGE_LOOP  for(centralbank_firm_revenues_message = get_first_centralbank_firm_revenues_message(); centralbank_firm_revenues_message != NULL; centralbank_firm_revenues_message = get_next_centralbank_firm_revenues_message(centralbank_firm_revenues_message)) {
/** \def FINISH_CENTRALBANK_FIRM_REVENUES_MESSAGE_LOOP
 * \brief Finish of loop to process centralbank_firm_revenues messages. */
#define FINISH_CENTRALBANK_FIRM_REVENUES_MESSAGE_LOOP }
/** \def START_FOREIGNSECTOR_CENTRALBANK_REVENUES_MESSAGE_LOOP
 * \brief Start of loop to process foreignsector_centralbank_revenues messages. */
#define START_FOREIGNSECTOR_CENTRALBANK_REVENUES_MESSAGE_LOOP  for(foreignsector_centralbank_revenues_message = get_first_foreignsector_centralbank_revenues_message(); foreignsector_centralbank_revenues_message != NULL; foreignsector_centralbank_revenues_message = get_next_foreignsector_centralbank_revenues_message(foreignsector_centralbank_revenues_message)) {
/** \def FINISH_FOREIGNSECTOR_CENTRALBANK_REVENUES_MESSAGE_LOOP
 * \brief Finish of loop to process foreignsector_centralbank_revenues messages. */
#define FINISH_FOREIGNSECTOR_CENTRALBANK_REVENUES_MESSAGE_LOOP }


struct FLAME_output
{
	int type; /* 0=snapshot 1=firm 2=household 3=equityfund 4=bank 5=government 6=centralbank 7=foreignsector 8=jpoffice 9=mall 10=reagency */
	int format; /* 0=XML */
	char * location;
	int period;
	int phase;
...
struct xmachine_memory_firm
{
	...
	int firmtype;	/**< X-machine memory variable firmtype of type int. */
	...
	int physical_capital_construction;	/**< X-machine memory variable physical_capital_construction of type int. */
	int physical_capital;	/**< X-machine memory variable physical_capital of type int. */
...
/** \struct xmachine_memory_foreignsector
 * \brief Holds memory of xmachine foreignsector.
 */
struct xmachine_memory_foreignsector
{
	int id;	/**< X-machine memory variable id of type int. */
	int it_no;	/**< X-machine memory variable it_no of type int. */
	int day_of_month_to_act;	/**< X-machine memory variable day_of_month_to_act of type int. */
	double xgoods_unit_price;	/**< X-machine memory variable xgoods_unit_price of type double. */
};

/** \struct xmachine_memory_foreignsector_holder
 * \brief Holds struct of memory of xmachine foreignsector.
 */
struct xmachine_memory_foreignsector_holder
{
	/*@dependent@*/ struct xmachine_memory_foreignsector * agent;	/**< Pointer to X-machine memory foreignsector. */

	/*@dependent@*/ struct xmachine_memory_foreignsector_holder * prev;	/**< Pointer to previous foreignsector agent in the list.  */
	/*@dependent@*/ struct xmachine_memory_foreignsector_holder * next;	/**< Pointer to next foreignsector agent in the list.  */
};

/** \struct xmachine_memory_foreignsector_holder
 * \brief Holds struct of memory of xmachine foreignsector.
 */
struct xmachine_memory_foreignsector_state
{
	/*@dependent@*/ struct xmachine_memory_foreignsector_holder * agents;	/**< Pointer to X-machine memory foreignsector. */
...
struct xmachine
{
	...
	/*@dependent@*/ /*@null@*/ /*@out@*/ struct xmachine_memory_foreignsector * xmachine_foreignsector;	/**< Pointer to X-machine memory of type foreignsector.  */
...
/** \var void* FLAME_m_firm_foreignsector_amount_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_foreignsector_amount_composite_params;

/** \struct m_firm_foreignsector_amount
 * \brief Holds message of type firm_foreignsector_amount_message.
 */
struct m_firm_foreignsector_amount
{
	int id;	/**< Message memory variable id of type int. */
...
/** \var void* FLAME_m_centralbank_firm_revenues_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_centralbank_firm_revenues_composite_params;

/** \struct m_centralbank_firm_revenues
 * \brief Holds message of type centralbank_firm_revenues_message.
 */
struct m_centralbank_firm_revenues
{
	int id;	/**< Message memory variable id of type int. */
	double revenues;	/**< Message memory variable revenues of type double. */
};

/** \var void* FLAME_m_foreignsector_centralbank_revenues_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_foreignsector_centralbank_revenues_composite_params;

/** \struct m_foreignsector_centralbank_revenues
 * \brief Holds message of type foreignsector_centralbank_revenues_message.
 */
struct m_foreignsector_centralbank_revenues
{
	int id;	/**< Message memory variable id of type int. */
	double fx_revenues;	/**< Message memory variable fx_revenues of type double. */
};
...
/** \var typedef xmachine_memory_foreignsector xmachine_memory_foreignsector
 * \brief Typedef for xmachine_memory_foreignsector struct.
 */
typedef struct xmachine_memory_foreignsector xmachine_memory_foreignsector;
/** \var typedef xmachine_memory_foreignsector xmachine_memory_foreignsector
 * \brief Typedef for xmachine_memory_foreignsector struct.
 */
typedef struct xmachine_memory_foreignsector_holder xmachine_memory_foreignsector_holder;
/** \var typedef xmachine_memory_foreignsector xmachine_memory_foreignsector
 * \brief Typedef for xmachine_memory_foreignsector struct.
 */
typedef struct xmachine_memory_foreignsector_state xmachine_memory_foreignsector_state;
...
/** \typedef m_firm_foreignsector_amount m_firm_foreignsector_amount
 * \brief Typedef for m_firm_foreignsector_amount struct.
 */
typedef struct m_firm_foreignsector_amount m_firm_foreignsector_amount;

/** \typedef m_centralbank_firm_revenues m_centralbank_firm_revenues
 * \brief Typedef for m_centralbank_firm_revenues struct.
 */
typedef struct m_centralbank_firm_revenues m_centralbank_firm_revenues;

/** \typedef m_foreignsector_centralbank_revenues m_foreignsector_centralbank_revenues
 * \brief Typedef for m_foreignsector_centralbank_revenues struct.
 */
typedef struct m_foreignsector_centralbank_revenues m_foreignsector_centralbank_revenues;
...
struct node_information
{
	...
	struct m_firm_foreignsector_amount * firm_foreignsector_amount_messages;	/**< Pointer to firm_foreignsector_amount message list. */
	struct m_centralbank_firm_revenues * centralbank_firm_revenues_messages;	/**< Pointer to centralbank_firm_revenues message list. */
	struct m_foreignsector_centralbank_revenues * foreignsector_centralbank_revenues_messages;	/**< Pointer to foreignsector_centralbank_revenues message list. */
...
/** \var m_firm_foreignsector_amount * temp_firm_foreignsector_amount_message
* \brief Pointer to m_firm_foreignsector_amount to initialise linked list. */
m_firm_foreignsector_amount * temp_firm_foreignsector_amount_message;
/** \var m_centralbank_firm_revenues * temp_centralbank_firm_revenues_message
* \brief Pointer to m_centralbank_firm_revenues to initialise linked list. */
m_centralbank_firm_revenues * temp_centralbank_firm_revenues_message;
/** \var m_foreignsector_centralbank_revenues * temp_foreignsector_centralbank_revenues_message
* \brief Pointer to m_foreignsector_centralbank_revenues to initialise linked list. */
m_foreignsector_centralbank_revenues * temp_foreignsector_centralbank_revenues_message;
...
/* Pointer to list of firm agents in state FirmExportReceiveSales state */
//xmachine_memory_firm * temp_xmachine_firm_FirmExportReceiveSales;
xmachine_memory_firm_state * firm_FirmExportReceiveSales_state;
/* Pointer to list of firm agents in state FirmExportMarket state */
//xmachine_memory_firm * temp_xmachine_firm_FirmExportMarket;
xmachine_memory_firm_state * firm_FirmExportMarket_state;
...
/* Pointer to list of firm agents in state FirmExportLabourDemand state */
//xmachine_memory_firm * temp_xmachine_firm_FirmExportLabourDemand;
xmachine_memory_firm_state * firm_FirmExportLabourDemand_state;
...
/* Pointer to list of firm agents in state FirmProductionExport state */
//xmachine_memory_firm * temp_xmachine_firm_FirmProductionExport;
xmachine_memory_firm_state * firm_FirmProductionExport_state;
...
/* Pointer to list of firm agents in state FirmExportStart state */
//xmachine_memory_firm * temp_xmachine_firm_FirmExportStart;
xmachine_memory_firm_state * firm_FirmExportStart_state;
...
/* Pointer to list of centralbank agents in state CentralBankExport state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankExport;
xmachine_memory_centralbank_state * centralbank_CentralBankExport_state;
...
/* Pointer to current $agent_name agent */
/*@dependent@*/ /*@null@*/ /*@out@*/ xmachine_memory_foreignsector * current_xmachine_foreignsector;
/*@dependent@*/ xmachine_memory_foreignsector_holder * temp_xmachine_foreignsector_holder;
/*@dependent@*/ /*@null@*/ /*@out@*/ xmachine_memory_foreignsector_holder * current_xmachine_foreignsector_holder;
xmachine_memory_foreignsector_state * current_xmachine_foreignsector_next_state; /* New agents added to this state */
/* Pointer to list of foreignsector agents in state ForeignSectorExportsPayment state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_ForeignSectorExportsPayment;
xmachine_memory_foreignsector_state * foreignsector_ForeignSectorExportsPayment_state;
/* Pointer to list of foreignsector agents in state end state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_end;
xmachine_memory_foreignsector_state * foreignsector_end_state;
/* Pointer to list of foreignsector agents in state ForeignSectorExportsPricing state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_ForeignSectorExportsPricing;
xmachine_memory_foreignsector_state * foreignsector_ForeignSectorExportsPricing_state;
/* Pointer to list of foreignsector agents in state ForeignSectorExportsStart state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_ForeignSectorExportsStart;
xmachine_memory_foreignsector_state * foreignsector_ForeignSectorExportsStart_state;
/* Pointer to list of foreignsector agents in state ForeignsectorLoop state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_ForeignsectorLoop;
xmachine_memory_foreignsector_state * foreignsector_ForeignsectorLoop_state;
/* Pointer to list of foreignsector agents in state start state */
//xmachine_memory_foreignsector * temp_xmachine_foreignsector_start;
xmachine_memory_foreignsector_state * foreignsector_start_state;
/* Pointer to current $agent_name agent */
...
MBt_Board b_firm_foreignsector_amount;
MBt_Iterator i_firm_foreignsector_amount;

MBt_Board b_centralbank_firm_revenues;
MBt_Iterator i_centralbank_firm_revenues;

MBt_Board b_foreignsector_centralbank_revenues;
MBt_Iterator i_foreignsector_centralbank_revenues;
...
/** \var m_firm_foreignsector_amount * firm_foreignsector_amount_message
* \brief Pointer to message struct for looping through firm_foreignsector_amount message list */
m_firm_foreignsector_amount * firm_foreignsector_amount_message;
/** \var m_centralbank_firm_revenues * centralbank_firm_revenues_message
* \brief Pointer to message struct for looping through centralbank_firm_revenues message list */
m_centralbank_firm_revenues * centralbank_firm_revenues_message;
/** \var m_foreignsector_centralbank_revenues * foreignsector_centralbank_revenues_message
* \brief Pointer to message struct for looping through foreignsector_centralbank_revenues message list */
m_foreignsector_centralbank_revenues * foreignsector_centralbank_revenues_message;
...
m_firm_foreignsector_amount * add_firm_foreignsector_amount_message_internal(void);
m_firm_foreignsector_amount * get_first_firm_foreignsector_amount_message(void);
m_firm_foreignsector_amount * get_next_firm_foreignsector_amount_message(m_firm_foreignsector_amount * current);
void freefirm_foreignsector_amountmessages(void);

void add_centralbank_firm_revenues_message(int id, double revenues);
m_centralbank_firm_revenues * add_centralbank_firm_revenues_message_internal(void);
m_centralbank_firm_revenues * get_first_centralbank_firm_revenues_message(void);
m_centralbank_firm_revenues * get_next_centralbank_firm_revenues_message(m_centralbank_firm_revenues * current);
void freecentralbank_firm_revenuesmessages(void);

void add_foreignsector_centralbank_revenues_message(int id, double fx_revenues);
m_foreignsector_centralbank_revenues * add_foreignsector_centralbank_revenues_message_internal(void);
m_foreignsector_centralbank_revenues * get_first_foreignsector_centralbank_revenues_message(void);
...
void freeforeignsector_centralbank_revenuesmessages(void);
...
m_firm_foreignsector_amount * get_next_message_firm_foreignsector_amount_in_range(m_firm_foreignsector_amount * current);



m_centralbank_firm_revenues * get_next_message_centralbank_firm_revenues_in_range(m_centralbank_firm_revenues * current);



m_foreignsector_centralbank_revenues * get_next_message_foreignsector_centralbank_revenues_in_range(m_foreignsector_centralbank_revenues * current);
...
int firm_production_produce_export_goods(void);
...
int centralbank_export_transactions(void);
...
int foreignsector_iterate(void);
int foreignsector_export_buy(void);
...
int foreignsector_export_pricing(void);
int foreignsector_export_pay(void);
