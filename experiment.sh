...
sed 's|betaval = "0.30"|betaval = "0.50"|' ./outputs/scripts/singleRunAnals.R > ./outputs/scripts/plot0.R
sed 's|niter = 3600|niter = 3600|' ./outputs/scripts/plot0.R > ./outputs/scripts/plot00.R
sed 's|data_household = 1|data_household = 1|' ./outputs/scripts/plot00.R > ./outputs/scripts/plot.R
rm ./outputs/scripts/plot0.R
rm ./outputs/scripts/plot00.R
...
Rscript ./outputs/scripts/plot.R
rm ./outputs/plots/0.50/*.png
mv ./outputs/plots/*.png ./outputs/plots/0.50/
rm ./outputs/scripts/plot.R

rm ./outputs/data/0.50/*.txt
mv ./outputs/data/*.txt ./outputs/data/0.50/
...
git add ./outputs/plots/0.55/*.png
git commit -a -m "Adding plots for beta = 0.55"
git push origin master
