/**
 * \file  reagency_agent_header.h
 * \brief Header for agent type memory access.
 */

/** \def ID
 * \brief Direct access to id of reagency agent memory variable. */
...
/** \def HOUSING_TRANSACTIONS
 * \brief Direct access to housing_transactions of reagency agent memory variable. */
